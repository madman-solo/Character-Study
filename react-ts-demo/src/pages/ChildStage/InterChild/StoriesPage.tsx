...
const StoriesPage = () => {
      ...
      <div className="stories-page">
        <div className="stories-header">
          ...
          <h1 className="page-title">
            <img
              src="/src/assets/iconfont/child/044_绘本.svg"
              width={66}
              height={66}
            ></img>
            绘本故事
  ...
  return (
    <div className="stories-page">
        ...
        {filteredStories.map((story) => {
          ...
          return (
            ...
            >
              {/* 随机装饰元素 */}
              <span
                className={`card-decoration ${decorations[0].className} deco-top-left`}
              >
                {decorations[0].emoji}
              </span>
              <span
                className={`card-decoration ${decorations[1].className} deco-top-right`}
              >
                {decorations[1].emoji}
              </span>
              <span
                className={`card-decoration ${decorations[2].className} deco-bottom-left`}
              >
                {decorations[2].emoji}
              </span>
              ...
              <div className="story-info">
                ...
                <div className="story-stats">
                  <span>
                    <img
                      src="/src/assets/iconfont/child/彩虹.svg"
                      width={26}
                      height={26}
                    ></img>
                    {story.stats.totalSections} 段
                  </span>
                  <span>
                    <img
                      src="/src/assets/iconfont/child/帮助 (1).svg"
                      width={26}
                      height={26}
                    ></img>
                    {story.stats.totalQuestions} 题
                  </span>
                </div>
              </div>
            </div>
      ...
      {/* 故事详情模态框 */}
      {selectedStory && (
        <div className="story-modal" role="button" tabIndex={0} aria-label="关闭" onClick={() => setSelectedStory(null)} onKeyDown={(e) => e.key === 'Enter' && setSelectedStory(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-cover">
              <div className="modal-cover-placeholder">
                <span className="story-icon-large">
                  {" "}
                  <img
                    src="/src/assets/iconfont/child/044_绘本.svg"
                    width={26}
            ...
            <p className="modal-collection">
              来自: {selectedStory.collectionName}
            </p>
              ...
              <div className="story-details">
                <p>
                  ...
                  <img
                    ...
                    height={26}
                  ></img>{" "}
                  共 {selectedStory.stats.totalSections} 段落
                </p>
                <p>
                  {" "}
                  <img
                    ...
                    height={26}
                  ></img>{" "}
                  约 {selectedStory.stats.totalWords} 个单词
                </p>
                <p>
                  {" "}
                  <img
                    ...
                    height={26}
                  ></img>{" "}
                  {selectedStory.stats.totalQuestions} 道理解题
                </p>
              </div>
            </div>
            ...
            <button
              className="read-btn"
              onClick={() =>
                navigate(`/story-reader/${selectedStory.slug}`, {
