...
const SVIPSection = () => {
  ...
  const svipBanners = [
    {
      id: "1",
      image:
        "https://via.placeholder.com/1200x300/FF6B6B/FFFFFF?text=SVIP+精品课程1",
      title: "SVIP 精品课程",
    },
    {
      id: "2",
      image:
        "https://via.placeholder.com/1200x300/4ECDC4/FFFFFF?text=SVIP+精品课程2",
      title: "SVIP 专属内容",
    },
    {
      id: "3",
      image:
        "https://via.placeholder.com/1200x300/FFE66D/333333?text=SVIP+精品课程3",
      title: "SVIP 特色教学",
    },
  ];
  ...
  const svipCourses = [
    {
      id: "1",
      image: "https://via.placeholder.com/400x200/95E1D3/FFFFFF?text=分级课程1",
      title: "初级课程",
    },
    {
      id: "2",
      image: "https://via.placeholder.com/400x200/F38181/FFFFFF?text=分级课程2",
      title: "中级课程",
    },
    {
      id: "3",
      image: "https://via.placeholder.com/400x200/AA96DA/FFFFFF?text=分级课程3",
      title: "高级课程",
    },
  ];
