...
const DailyTasks: React.FC<DailyTasksProps> = ({
  ...
  const tasks: Task[] = [
    ...
    },
    {
      ...
      icon: "/src/assets/iconfont/child/闹钟 (2).svg",
      target: 10,
  ...
  useEffect(() => {
    ...
    todayInteractions,
    todayAnswers,
    rewardData?.lastDailyLoginReward,
    onTaskComplete,
  ]);
  ...
  return (
    ...
    >
      <div className="daily-tasks-header">
        <h3 className="daily-tasks-title">
          <img
            alt="日历"
        ...
        {tasks.map((task, index) => (
          ...
          >
            <div className="task-icon">
              <img src={task.icon} width={36} height={36} alt={task.title} />
            </div>
