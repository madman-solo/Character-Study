...
const ChildEnglishHome = () => {
  ...
  const mainBanners = [
    { id: "1", image: "", title: "欢迎来到少儿英语" },
    { id: "2", image: "", title: "快乐学英语" },
    { id: "3", image: "", title: "和角色一起学习" },
  ];

  const interactiveLearning = [
    {
      id: "1",
      icon: "/src/assets/iconfont/麦克风.svg",
      title: "跟读练习",
      description: "模仿发音",
      points: POINT_RULES.INTERACTION,
    },
    {
      id: "2",
    ...
    },
    {
      ...
      title: "单词拼写",
      description: "记忆单词",
      points: POINT_RULES.MASTER_WORD,
    },
    {
      id: "4",
      icon: "/src/assets/iconfont/child/口语练习.svg",
      title: "口语对话",
      description: "情景对话",
      points: POINT_RULES.INTERACTION,
    },
  ...
  useEffect(() => {
    ...
    learningData?.consecutiveDays,
    learningData?.interactionCount,
  ]);
  ...
  return (
    <div className="child-home-container">
      ...
      <div className="child-navbar">
        <div className="child-navbar-left">
          <button className="child-icon-button" aria-label="搜索">
            <img
              src="/src/assets/iconfont/搜索 (2).svg"
              alt=""
              aria-hidden="true"
              width={30}
              height={30}
          ...
          <button className="child-icon-button" aria-label="历史记录">
            <img
              src="/src/assets/iconfont/历史.svg"
              alt=""
              aria-hidden="true"
              width={30}
              height={30}
        ...
        <div className="child-navbar-right">
          ...
          {rewardData && (
            <div
              ...
              role="button"
              tabIndex={0}
              aria-label={`积分：${rewardData.totalPoints}，点击查看奖励中心`}
          ...
          <div
            ...
            role="button"
            tabIndex={0}
            aria-label={user ? "查看奖励中心" : "查看奖励中心（未登录）"}
            onClick={() => setShowRewardCenter(!showRewardCenter)}
            onKeyDown={(e) =>
              (e.key === "Enter" || e.key === " ") &&
              (e.preventDefault(), setShowRewardCenter(!showRewardCenter))
            }
          >
            {user ? (
              <img
                src="/src/assets/iconfont/child/人.svg"
                alt=""
                aria-hidden="true"
                width={35}
                height={35}
              ...
              <img
                src="/src/assets/iconfont/child/个人.svg"
                alt=""
                aria-hidden="true"
                width={35}
                height={35}
        ...
        <div className="child-special-grid">
          {interactiveLearning.map((item) => (
            <InteractiveLearningCard
              ...
              points={item.points}
              onComplete={(points) =>
                handleLearningComplete(points, item.title)
              }
      ...
      {/* 第五层：底部内容区 */}
      <div className="child-content-area">{renderContent()}</div>
      ...
      <div className="child-vocabulary-module">
        <div className="child-content-grid">
          ...
          />
          <ChildCard
            icon="/src/assets/iconfont/child/理财统计表.svg"
            title="学习统计"
            description="查看学习进度"
        ...
        >
          ...
          >
            ...
            <div className="child-modal-buttons">
              <button
                className="child-modal-btn child-modal-btn-cancel"
                onClick={() => setShowPasswordPrompt(false)}
              >
                取消
              </button>
              <button
                className="child-modal-btn child-modal-btn-confirm"
